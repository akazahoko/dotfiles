...
hl.bind("XF86MonBrightnessUp",
    hl.dsp.exec_cmd(OSD_DIR .. "/brightnessctl.sh up 5")
)
hl.bind("XF86MonBrightnessDown",
    hl.dsp.exec_cmd(OSD_DIR .. "/brightnessctl.sh down 5")
)

hl.bind("SHIFT + XF86MonBrightnessUp",
    hl.dsp.exec_cmd(OSD_DIR .. "/brightnessctl.sh up 1")
)
hl.bind("SHIFT + XF86MonBrightnessDown",
    hl.dsp.exec_cmd(OSD_DIR .. "/brightnessctl.sh down 1") 
)
...
hl.bind("XF86SelectiveScreenshot", hl.dsp.exec_cmd(app.screenshot))
hl.bind("SHIFT + CTRL + SUPER + S", hl.dsp.exec_cmd(DMENU_DIR .. "/capture.sh"))
hl.bind("Print", hl.dsp.exec_cmd(DMENU_DIR .. "/capture.sh"))
